            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="input-group mb-3" style="width: 300px; float: right;">
                        ...
                        placeholder="Buscar Emision..." aria-label="Buscar Emision..." aria-describedby="search-icon">
                    </div>


                    <a href="{{ route('emisiones.create') }}" class="btn btn-success mb-3">+ Agregar Emision</a>                    

                    <table class="table table-striped table-hover table-bordered table-sm text-center" style="font-size:14px" id="emisionesTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('emisiones.edit', $emision->id) }}" 
                                        class="btn btn-sm" title="Editar"><img src="{{ asset('img/iconos/editar3.png') }}"  
                                        alt="Edit Icon" style="width: 30px; height: 30px;" class="rounded-full me-3" ></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
