...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Lista de GeometrÃ­a/Soporte') }}
        </h2>
    </x-slot>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="input-group mb-3" style="width: 300px; float: right;">
                        ...
                        placeholder="Buscar geometrÃ­a..." aria-label="Buscar geometrÃ­a..." aria-describedby="search-icon">
                    </div>

                    <a href="{{ route('geometrias.create') }}" class="btn btn-success mb-3">+ Agregar GeometrÃ­a/Soporte</a>

                    <table class="table table-striped table-hover table-bordered table-sm text-center" style="font-size:14px" id="geometriasTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('geometrias.edit', $geometria->id) }}" 
                                        class="btn btn-sm" title="Editar"><img src="{{ asset('img/iconos/editar3.png') }}"  
                                        alt="Edit Icon" class="w-6 h-6 rounded-full me-2"></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
