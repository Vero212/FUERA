            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="input-group mb-3" style="width: 300px; float: right;">
                        ...
                        placeholder="Buscar Unidad..." aria-label="Buscar Unidad..." aria-describedby="search-icon">
                    </div>


                    <a href="{{ route('unidades.create') }}" class="btn btn-success mb-3">+ Agregar Unidad</a>

                    <table class="table table-striped table-hover table-bordered table-sm text-center" style="font-size:14px" id="unidadesTable">
